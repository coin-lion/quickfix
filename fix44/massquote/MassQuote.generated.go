...
//MassQuote is the fix44 MassQuote type, MsgType = i
...
func (m MassQuote) SetAcctIDSource(v enum.AcctIDSource) {
...
func (m MassQuote) GetAcctIDSource() (v enum.AcctIDSource, err quickfix.MessageRejectError) {
